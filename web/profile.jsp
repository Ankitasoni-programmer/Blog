  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
          <a class="nav-link" href="#"><span class="fa fa-bell-o"></span>  Code <span class="sr-only">(current)</span></a>
      </li>
      ...
      <li class="nav-item">
          <a class="nav-link" href="#"><span class="fa fa-address-card-o
"></span>Contact</a>
      </li>
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="list-group">
                            ...
                            %>
                            <a href="#" class="link list-group-item list-group-item-action"><%= cc.getName()%></a>
  ...
  <tbody>
    ...
    <tr>
      ...
      <div  id="profile-edit" style="display:none">
          ...
          <form action="Editservlet" method="post" enctype="multipart/form-data">
              ...
              <table class="table">
                  ...
                  <tr>
                      <td>    About  </td>
                      <td> <textarea rows="5"class="form-control" name="userabout"><%=     user.getAbout()%></textarea><td>
      ...
      <div class="modal-footer">
        <button type="button" id="edit-profile-button" class="btn btn-primary" data-dismiss="modal">Edit</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Provide the post deatail....</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
           ...
           <div class="form-group">
               ...
               <input type="file" name="pic" >          
                  ...
                  <div class="container text-center" >
                       ...
                       <button typr="submit" class="btn btn-outline-primary">Post</button>
       ...
       <script src="https://code.jquery.com/jquery-3.7.1.min.js" integrity="sha256-/JqT3SQfawRcv/BIHPThkBvs0OEvtFFmqPF/lYI/Cxo=" crossorigin="anonymous"></script>
        ...
        <script>
            ...
            $(document).ready(function(e)
            {
                $.ajax({
                    url:"load_posts.jsp",
                    success:function(data,texttStatus,jqXHR)
                    {
                        console.log(data);
                        $("#loader").hide();
